...
export default function NuevaCuentaPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (currentBalance === '') return fail('Ingresa el saldo inicial.')
                ...
                <div className="max-w-3xl mx-auto px-6 py-12">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <h1 className="text-5xl font-extrabold tracking-tight">Nueva Cuenta</h1>
                            <p className="text-slate-400 mt-3 text-lg">
                                Registra una nueva cuenta para rastrear mejor tu dinero.
                            </p>
                        </div>
            ...
            <section className="max-w-3xl mx-auto px-6 -mt-8">
                <div className="rounded-[2.5rem] border border-slate-200 bg-white p-8 shadow-2xl">
                    <div className="mb-8 border-b border-slate-100 pb-6">
                        ...
                        <p className="text-slate-400 text-sm mt-1">Completa los datos básicos para empezar.</p>
                    </div>
